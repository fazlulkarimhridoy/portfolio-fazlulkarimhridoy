        ...
        <section id="banner" className="text-white bg-gray-900 overflow-hidden pt-14">
            <div className="mx-auto md:pt-5 lg:pt-10 xl:pt-20 pb-5 md:px-4 lg:px-20 xl:px-60 md:py-5 lg:py-10 xl:py-28 md:flex md:justify-between md:h-dvh md:items-center">
                <div className="text-center animate__animated animate__bounceInLeft">
                    ...
                    <p className="text-gray-400 mx-auto px-6 mt-4 max-w-xl text-base lg:text-xl/relaxed text-justify">
                    ...
                    <div className="lg:gap-y-10 lg:-mt-[260px] lg:-ml-[550px] xl:-ml-[700px] flex flex-row lg:flex-col items-center justify-center gap-x-10 md:gap-x-16 mt-5 md:mt-10">
                        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }}>
                            <a href="https://github.com/fazlulkarimhridoy">
                                <FaGithub className="hover:text-sky-500" size={50}></FaGithub>
                            </a>
                        </motion.div>
                        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }}>
                            <a href="https://www.linkedin.com/in/fazlulkarimhridoy23">
                                <FaLinkedin className="hover:text-sky-500" size={50}></FaLinkedin>
                            </a>
                        </motion.div>
                        <motion.div whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }}>
                            <a href="https://www.facebook.com/hriiiiiidoy">
                                <FaFacebook className="hover:text-sky-500" size={50}></FaFacebook>
                            </a>
                        </motion.div>
                    </div>
                </div>
                ...
                >
                    <img
                        id="blob"
                        className="animate__animated animate__bounceInRight border-[18px] rounded-badge bg-white w-[350px] border-gray-700 hover:border-gray-500 hover:transition-all hover:ease-out hover:duration-1000"
                        src={AuthorImage}
                    />
                </motion.div>
            </div>
