...
const Banner = () => {
    ...
    return (
        <section
            id="banner"
            className="text-white bg-gray-900 overflow-hidden pt-14"
        >
            <div className="mx-auto md:pt-5 lg:pt-10 xl:pt-20 pb-5 md:px-4 lg:px-20 xl:px-60 md:py-5 lg:py-10 xl:py-28 md:flex md:justify-between md:h-dvh md:items-center">
                <div className="text-center animate__animated animate__bounceInLeft">
                    ...
                    <p className="text-gray-400 mx-auto px-6 mt-4 max-w-xl text-base lg:text-xl/relaxed text-justify">
                        With 1.5 years of professional web development
                        experience, I’ve crafted a range of innovative and
                        functional projects. My expertise spans React.js,
                        TailwindCSS, Express.js, allowing me to
                        build sleek, responsive web applications that deliver
