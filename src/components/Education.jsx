            ...
            <div className="container max-w-5xl px-4 py-12 mx-auto">
                <div className="grid gap-4 mx-4 sm:grid-cols-12">
                    <div className="col-span-12 sm:col-span-3">
                        <h3 className="text-3xl font-semibold text-sky-500">Education</h3>
                        ...
                        <div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-300">
                            <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-sky-600">
                                ...
                                <time className="text-xs text-gray-600">
                                    CGPA - 2.80 out of 4.00 | Passing year - 2024
                                </time>
                            ...
                            <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-sky-600">
                                ...
                                <time className="text-xs text-gray-600">
                                    GPA - 4.17 out of 5.00 | Passing year - 2018
                                </time>
                                <p className="mt-3">Firoza Bashar Ideal College (2016-2017)</p>
                            </div>
                            <div className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-sky-600">
                                <h3 className="text-xl font-semibold">Secondary School Certificate</h3>
                                <time className="text-xs text-gray-600">
                                    GPA - 4.67 out of 5.00 | Passing year - 2016
                                </time>
                                <p className="mt-3">Badshah Faisal Institute (2014-2015)</p>
                            </div>
                        </div>
                    </div>
                </div>
